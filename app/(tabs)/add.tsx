...
export default function AddTaskScreen() {
  ...
  // Data Pilihan
  const categories = [
    { id: 'Study', icon: 'book-open', color: COLORS.primary },
    { id: 'Wellness', icon: 'heart', color: COLORS.statusGreen },
    { id: 'Errand', icon: 'shopping-bag', color: COLORS.statusOrange },
    { id: 'Work', icon: 'briefcase', color: COLORS.textSecondary },
  ];

  const impacts = [
    { id: 'Low', label: 'Light', color: COLORS.statusGreen },
    { id: 'Medium', label: 'Moderate', color: COLORS.statusYellow },
    { id: 'High', label: 'Heavy', color: COLORS.statusRed },
  ];
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={TYPOGRAPHY.h2}>Select Date</Text>
  ...
  const TimePickerModal = () => (
    <Modal visible={isTimeModalVisible} transparent animationType="slide" onRequestClose={() => setTimeModalVisible(false)}>
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={TYPOGRAPHY.h2}>Set Duration</Text>
          ...
          {/* START TIME */}
          <Text style={styles.pickerSubLabel}>Start Time</Text>
          ...
          {/* END TIME */}
          <Text style={styles.pickerSubLabel}>End Time</Text>
          <View style={styles.timeRow}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.timeScroll}>
              {hours.map(h => (
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="e.g., Data Science Review"
          ...
          <View style={styles.inputGroup}>
            <View style={styles.labelRow}>
              <Text style={styles.inputLabel}>Estimated Load (Impact)</Text>
          ...
          <View style={styles.syncCard}>
            <View style={styles.syncContent}>
              ...
              <View>
                <Text style={TYPOGRAPHY.bodyMedium}>Sync to Google Calendar</Text>
